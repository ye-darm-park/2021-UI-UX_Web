      ...
      <?php echo G5_URL ?>
        ...
        <ul class="hd_login">
            ...
            <?php } else {  ?>
              ...
              <li><a href="<?php echo $GLOBALS['variable'] = something;G5_BBS_URL ?>/login.php">로그인</a></li>
            <?php }  ?>
...
<script>
  window.onload = function(){
    ...
    if(menuDep == "커뮤니티"){
      $(".subVisual .txt").html("자유롭게 커뮤니티 할 수 있는 곳입니다.")
    }
  };
</script>
<?}?>
...
<div id="wrapper">
    ...
    <div id="container" <? if(defined('_INDEX_')){?>style="width:1200px"<?}?>> <!-- 930 -->
        <?php if (!defined("_INDEX_")) { ?>
          <div>
            H > <span class="loc1D"></span> > <?php echo get_text($g5['title']); ?> </div>
